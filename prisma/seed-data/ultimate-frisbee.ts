...
export const { milestones, criteriaByLevel } = ladderC([
  ...
  ["Zdobądź 3 zdobycze w jednym meczu", undefined, prog("zdobycze-mecz", 3)],
  ...
  ["Zostań podstawowym zawodnikiem czołowej drużyny ligowej"],
  ...
  ["Zostań podstawowym zawodnikiem drużyny walczącej o mistrzostwo"],
