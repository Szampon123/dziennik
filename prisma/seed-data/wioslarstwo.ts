...
export const milestones = ladder([
  // 1-10 · Pierwsze kroki
  ["Pokonaj 500 m bez przerwy", "Poznaj sekwencję: nogi → tułów → ręce."],
  ["Pokonaj 1000 m bez przerwy"],
  ["Wiosłuj 5 minut bez przerwy"],
  ["Pokonaj 1500 m bez przerwy"],
  ["Wiosłuj 10 minut bez przerwy"],
  ["Pokonaj 2000 m bez przerwy", "Dystans olimpijski — na razie bez patrzenia na zegar."],
  ["Wiosłuj 15 minut bez przerwy"],
  ["Pokonaj 2500 m bez przerwy"],
  ["Wiosłuj 20 minut bez przerwy"],
  ["Pokonaj 3000 m bez przerwy"],
  // 11-25 · Regularny
  ["Wiosłuj 2 razy w tygodniu przez 4 kolejne tygodnie"],
  ["Pokonaj 2000 m poniżej 10:00", "Średnio 2:30/500 m."],
  ["Pokonaj 4000 m bez przerwy"],
  ["Pokonaj 500 m poniżej 2:10"],
  ["Pokonaj 5000 m bez przerwy"],
  ["Pokonaj 10 km łącznie w jednym tygodniu"],
  ["Pokonaj 2000 m poniżej 9:30"],
  ["Pokonaj 6000 m bez przerwy"],
  ["Pokonaj łącznie 50 km"],
  ["Pokonaj 500 m poniżej 2:00"],
  ["Wiosłuj 30 minut bez przerwy"],
  ["Pokonaj 2000 m poniżej 9:00"],
  ["Pokonaj 15 km łącznie w jednym tygodniu"],
  ["Pokonaj 8000 m bez przerwy"],
  ["Pokonaj 10 000 m bez przerwy", "Dycha na ergu — próba charakteru."],
  // 26-45 · Średniozaawansowany
  ["Wiosłuj 3 razy w tygodniu przez 12 kolejnych tygodni"],
  ["Pokonaj 2000 m poniżej 8:45"],
  ["Pokonaj 500 m poniżej 1:55"],
  ["Pokonaj 60 km łącznie w jednym miesiącu"],
  ["Pokonaj 12 km bez przerwy"],
  ["Pokonaj 2000 m poniżej 8:30", "Średnio 2:07/500 m."],
  ["Pokonaj 20 km łącznie w jednym tygodniu"],
  ["Pokonaj 5000 m poniżej 22:30"],
  ["Pokonaj łącznie 200 km"],
  ["Pokonaj 2000 m poniżej 8:15"],
  ["Wiosłuj 60 minut bez przerwy", "Pełna godzina pracy."],
  ["Pokonaj 15 km bez przerwy"],
  ["Pokonaj 500 m poniżej 1:50"],
  ["Pokonaj 2000 m poniżej 8:00", "Psychologiczna granica ósemki."],
  ["Pokonaj 25 km łącznie w jednym tygodniu"],
  ["Pokonaj 5000 m poniżej 21:00"],
  ["Pokonaj 100 km łącznie w jednym miesiącu"],
  ["Pokonaj 18 km bez przerwy"],
  ["Pokonaj 2000 m poniżej 7:50"],
  ["Pokonaj półmaraton na ergu (21 097 m)", "Klasyczny challenge Concept2."],
  // 46-65 · Zaawansowany
  ["Pokonaj 500 m poniżej 1:45"],
  ["Pokonaj 2000 m poniżej 7:40"],
  ["Pokonaj łącznie 500 km"],
  ["Pokonaj 30 km łącznie w jednym tygodniu"],
  ["Pokonaj 5000 m poniżej 20:00", "Równe 2:00/500 m przez 5 km."],
  ["Pokonaj 2000 m poniżej 7:30", "Solidny poziom wytrenowanego amatora."],
  ["Pokonaj 25 km bez przerwy"],
  ["Pokonaj 150 km łącznie w jednym miesiącu"],
  ["Pokonaj 500 m poniżej 1:42"],
  ["Pokonaj 2000 m poniżej 7:20"],
  ["Pokonaj 5000 m poniżej 19:00"],
  ["Pokonaj 40 km łącznie w jednym tygodniu"],
  ["Pokonaj 30 km bez przerwy"],
  ["Pokonaj łącznie 1000 km"],
  ["Pokonaj 2000 m poniżej 7:10"],
  ["Pokonaj 500 m poniżej 1:40"],
  ["Pokonaj 5000 m poniżej 18:30"],
  ["Pokonaj 200 km łącznie w jednym miesiącu"],
  ["Pokonaj 2000 m poniżej 7:00", "Siódemka pęka — poziom klubowy."],
  ["Pokonaj maraton na ergu (42 195 m)", "Elitarny klub maratończyków Concept2."],
  // 66-85 · Wyczynowy
  ["Pokonaj 500 m poniżej 1:38"],
  ["Pokonaj 2000 m poniżej 6:55"],
  ["Pokonaj 50 km łącznie w jednym tygodniu"],
  ["Pokonaj 5000 m poniżej 18:00"],
  ["Pokonaj 2000 m poniżej 6:50"],
  ["Pokonaj łącznie 2000 km"],
  ["Pokonaj 500 m poniżej 1:35"],
  ["Pokonaj 2000 m poniżej 6:45"],
  ["Pokonaj 250 km łącznie w jednym miesiącu"],
  ["Pokonaj 5000 m poniżej 17:30"],
  ["Pokonaj 2000 m poniżej 6:40"],
  ["Pokonaj 60 km łącznie w jednym tygodniu"],
  ["Pokonaj 500 m poniżej 1:33"],
  ["Pokonaj 2000 m poniżej 6:35"],
  ["Pokonaj 5000 m poniżej 17:00"],
  ["Pokonaj łącznie 3000 km"],
  ["Pokonaj 2000 m poniżej 6:30", "Czasy z czołówek rankingów amatorskich."],
  ["Pokonaj 300 km łącznie w jednym miesiącu"],
  ["Pokonaj 500 m poniżej 1:30"],
  ["Pokonaj 2000 m poniżej 6:25"],
  // 86-99 · Elita
  ["Pokonaj 5000 m poniżej 16:30"],
  ["Pokonaj 2000 m poniżej 6:20"],
  ["Pokonaj 80 km łącznie w jednym tygodniu"],
  ["Pokonaj 500 m poniżej 1:28"],
  ["Pokonaj 2000 m poniżej 6:15"],
  ["Pokonaj 5000 m poniżej 16:00"],
  ["Pokonaj łącznie 5000 km"],
  ["Pokonaj 2000 m poniżej 6:10"],
  ["Pokonaj 500 m poniżej 1:26"],
  ["Pokonaj 2000 m poniżej 6:05"],
  ["Pokonaj 5000 m poniżej 15:45"],
  ["Pokonaj 2000 m poniżej 6:00", "Sub-6 — mocna klubowa czołówka ergometru."],
  ["Pokonaj 500 m poniżej 1:24"],
